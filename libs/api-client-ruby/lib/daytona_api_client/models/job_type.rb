...
module DaytonaApiClient
  class JobType
    JOB_TYPE_UNSPECIFIED = "JOB_TYPE_UNSPECIFIED".freeze
    ...
    def self.all_vars
      @all_vars ||= [JOB_TYPE_UNSPECIFIED, CREATE_SANDBOX, START_SANDBOX, STOP_SANDBOX, DESTROY_SANDBOX, RESIZE_SANDBOX, CREATE_BACKUP, BUILD_SNAPSHOT, PULL_SNAPSHOT, RECOVER_SANDBOX, INSPECT_SNAPSHOT_IN_REGISTRY, REMOVE_SNAPSHOT, UPDATE_SANDBOX_NETWORK_SETTINGS, UNRECOGNIZED].freeze
    end
